...
public class Passer_a_signin extends javax.swing.JFrame {

    public Passer_a_signin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(Passer_a_signin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Passer_a_signin().setVisible(true);
            }
        });
    }
